...
func (g *Genpwd) printHelp() {
	...
	fmt.Println("Usage:")
	fmt.Println("  v genpwd                    Interactive TUI (default)")
	fmt.Println("  v genpwd -l 20              Generate a 20-char password to stdout")
	fmt.Println("  v genpwd -l 12 -n 5         Generate 5 passwords of length 12")
	fmt.Println("  v genpwd -l 16 -c           Generate and copy to clipboard")
	fmt.Println("  v genpwd -l 16 -ns          No special characters")
	fmt.Println()
	fmt.Println("Options:")
	...
	fmt.Println("  Space   Toggle checkbox")
