...
func (p *Pwd) printHelp() {
	...
	color.Println("Display the current working directory and automatically copy it to clipboard.")
	color.Println()
	color.Println("<fg=magenta;op=bold>Usage:</>")
	color.Println("  v pwd                        Print current directory and copy to clipboard")
	color.Println()
	color.Println("<fg=magenta;op=bold>Options:</>")
	color.Println("  <green>-h</>                        Show this help")
	color.Println()
	color.Println("<fg=magenta;op=bold>Example:</>")
	color.Println("  <gray># Get current path and have it ready to paste</>")
	color.Println("  v pwd")
	color.Println("  <gray># Output:</>")
	color.Println("  <gray># 📁 Current Directory:</>")
	color.Println("  <gray># /Users/username/projects/myapp</>")
	color.Println("  <gray># ✅ Copied to clipboard</>")
	color.Println()
	color.Println("<gray>The path is automatically copied to the system clipboard for easy sharing.</>")
	color.Println("<gray>--------------------------------------------------</>")
}
