...
func (d *Diff) printHelp() {
	...
	color.Println("Interactive text comparison with word-level highlighting and paste mode.")
	color.Println()
	color.Println("<fg=magenta;op=bold>Usage:</>")
	color.Println("  v diff                              Paste mode (paste both sides in TUI)")
	color.Println("  v diff <green>-left</> <f1> <green>-right</> <f2>       Compare two files")
	...
	color.Println("  <green>-clip</>           Read clipboard as a source")
	color.Println("  <green>-pipe</>           Read from stdin/pipe (auto-detected, used as left)")
	...
	color.Println("  <green>↑↓</> / <green>j k</>      Navigate lines")
	color.Println("  <green>n</> / <green>N</>         Next / previous diff hunk")
	color.Println("  <green>/</>             Search (type term, Enter to jump)")
	color.Println("  <green>c</>             Show only changed lines")
	color.Println("  <green>a</>             Show all lines")
	color.Println("  <green>e</>             Edit (return to paste mode)")
	color.Println("  <green>q</>             Quit")
	color.Println()
	color.Println("<fg=magenta;op=bold>Paste Mode Keys:</>")
	color.Println("  <green>Tab</>           Switch between left/right panel")
	color.Println("  <green>Ctrl-A</>        Select all")
	color.Println("  <green>Ctrl-C/X/V</>    Copy / cut / paste")
	color.Println("  <green>Ctrl-Z/Y</>      Undo / redo")
	color.Println("  <green>Ctrl-D</>        Compute diff")
	color.Println("  <green>Esc</>           Quit")
	color.Println()
