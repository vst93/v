...
func (j *Jv) printHelp() {
	...
	color.Println("Editor-style JSON viewer with syntax highlighting, folding, search, and editing.")
	color.Println()
	color.Println("<fg=magenta;op=bold>Usage:</>")
	color.Println("  v jv                         Interactive viewer (from clipboard)")
	color.Println("  v jv <green>-f</>                      Format (pretty-print) JSON")
	color.Println("  v jv <green>-c</>                      Compress (minify) JSON")
	color.Println("  v jv '{\"key\": \"value\"}'       Inline JSON/text argument")
	color.Println("  v jv <green>-file</> data.json         Read from file")
	color.Println("  echo '{..}' | v jv           Read from pipe")
	color.Println()
	color.Println("<fg=magenta;op=bold>Modes:</>")
	color.Println("  <green>-tui</>, <green>-i</>     Interactive tree viewer (default)")
	color.Println("  <green>-f</>           Format (pretty-print) JSON")
	color.Println("  <green>-c</>           Compress (minify) JSON to single line")
	color.Println("  <green>-e</>           Escape non-ASCII to \\uXXXX sequences")
	color.Println("  <green>-u</>           Unescape \\uXXXX sequences to UTF-8")
	color.Println()
	color.Println("<fg=magenta;op=bold>Options:</>")
	color.Println("  <green>-sort</>        Sort object keys alphabetically")
	color.Println("  <green>-raw</>         Disable colored output (plain text)")
	color.Println("  <green>-file</> <path> Read from file")
	color.Println("  <green>-url</> <url>   Read from URL (HTTP/HTTPS)")
	...
	color.Println()
	color.Println("<fg=magenta;op=bold>Viewer Keys:</>")
	color.Println("  <green>↑</> <green>↓</> / <green>j</> <green>k</>      Move cursor (PgUp/PgDn page, g/G first/last)")
	color.Println("  <green>Enter</> / <green>Space</> / <green>o</> Fold/unfold at cursor")
	color.Println("  <green>h</> / <green>l</>           Fold & jump to parent / unfold")
	color.Println("  <green>e</> / <green>c</>           Expand / collapse all")
	color.Println("  <green>i</>               Inline edit (Esc done, Ctrl-Z/Y undo/redo)")
	color.Println("  <green>I</>               Edit in $EDITOR (vim/nano/notepad)")
	color.Println("  <green>f</>               Reformat document")
	color.Println("  <green>/</> or <green>Ctrl-F</>     Search panel")
	color.Println("  <green>n</> / <green>N</> / <green>F3</>      Next / previous match")
	color.Println("  <green>Tab</>             Filter bar (.key [0] [\"k\"] .map(.k))")
	color.Println("  <green>u</>               Toggle \\uXXXX display")
	color.Println("  <green>F</> / <green>M</> / <green>E</>       Copy formatted / minified / escaped JSON")
	color.Println("  <green>y</> / <green>p</>           Copy value / path at cursor")
	color.Println("  <green>?</> / <green>q</>           Help / quit")
	color.Println()
	color.Println("<gray>Input priority: pipe > -file > -url > argument > clipboard</>")
	color.Println("<gray>Non-JSON input opens as plain editable text without formatting</>")
	color.Println("<gray>Theme adapts to terminal (OSC 11, COLORFGBG, or V_THEME=light|dark)</>")
	color.Println("<gray>--------------------------------------------------</>")
}
